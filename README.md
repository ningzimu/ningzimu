...
[![Stars](https://img.shields.io/github/stars/ningzimu/See_you_in_BUPT?style=social)](https://github.com/ningzimu/See_you_in_BUPT)

北京邮电大学计算机考研信息汇总，沉淀了长期维护的院校、专业和备考资料。

`BUPT` `Knowledge Base` `Education`

</td>
<td width="50%" valign="top">

### ⭐ [codex-ppt-skill](https://github.com/ningzimu/codex-ppt-skill)
[![Stars](https://img.shields.io/github/stars/ningzimu/codex-ppt-skill?style=social)](https://github.com/ningzimu/codex-ppt-skill)

面向 Codex 的 PPT 生成 Skill，用 gpt-image-2 生成整页图片并组装成演示文稿。
...
[![Star History Chart](https://api.star-history.com/svg?repos=ningzimu/codex-ppt-skill,ningzimu/image-to-editable-ppt-skill,ningzimu/claude-code-lens,ningzimu/awesome-ai-ppt&type=timeline)](https://www.star-history.com/?repos=ningzimu%2Fcodex-ppt-skill%2Cningzimu%2Fimage-to-editable-ppt-skill%2Cningzimu%2Fclaude-code-lens%2Cningzimu%2Fawesome-ai-ppt&type=timeline&logscale=&legend=top-left)
...
![Snake animation](https://raw.githubusercontent.com/ningzimu/ningzimu/output/github-contribution-grid-snake.svg)
